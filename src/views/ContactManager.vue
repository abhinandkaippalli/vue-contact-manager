    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col">
                ...
                <p class="fst-italic">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptatum repellat optio
                    facilis odit! Sed deleniti neque impedit magni at, inventore quasi corrupti similique numquam maiores
                    veritatis necessitatibus non dolorem totam!</p>
                <form>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
